                    ...
                    <form id="profile-form" action="{{ route('user.profile.update') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pseudo_first_name" class="form-label">Pseudo Name</label>
                                <input type="text" class="form-control" name="pseudo_name" id="pseudo_name"
                                       value="{{ auth()->user()->pseudo_name }}" disabled>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="pseudo_email" class="form-label">Pseudo Email Address</label>
                                <input type="email" class="form-control" name="pseudo_email" id="pseudo_email"
                                       value="{{ auth()->user()->pseudo_email }}" disabled>
                            </div>

                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pseudo_phone" class="form-label">Pseudo Phone No.</label>
                                <input type="text" class="form-control" name="pseudo_phone" id="pseudo_phone"
                                       value="{{ auth()->user()->pseudo_phone }}" disabled>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="target"
                                       value="{{ auth()->user()->target }}" disabled>
                            </div>
                            <div class="col-md-6 mb-3">
            ...
            $(document).ready(function () {
                ...
                $('#edit-profile-btn').click(function () {
                    ...
                    if (isEditMode) {
                        ...
                        $('#pseudo_name, #pseudo_email, #pseudo_phone')
                            .prop('disabled', false)
