...
<script>
    (function () {
        ...
        const blockedCountries = ['AF', 'AM', 'AZ', 'BD', 'BT', 'BN', 'KH', 'CN', 'GE', 'IN', 'ID', 'JP', 'KZ', 'KG', 'LA', 'MY', 'MV', 'MN', 'MM', 'NP', 'KP', 'PK', 'PS', 'PH', 'SG', 'KR', 'LK', 'TW', 'TJ', 'TH', 'TL', 'TM', 'UZ', 'VN'];
                                ...
                                @if (in_array('bank transfer', $invoiceDetails['invoice']['payment_methods']) && isset($invoiceDetails['invoice']['bank_details']) && !empty($invoiceDetails['invoice']['bank_details']) )
                                    <div
                                        ...
                                        <div class="" style="min-height:250px;">
                                            ...
                                            <div id="bd-att-sec" class=""
                                                 style="min-height:250px;padding: 0px 20px; line-height: 14px; font-size: 12px;">
                                                <div class="form-txt">
