<!-- Add the email section with a loader -->
...
<script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('/admin/customer/contact/emails/fetch?customer_email=' + encodeURIComponent(customerEmail) + '&folder=' + encodeURIComponent(folder) + '&page=' + page + '&limit=' + limit, {
                method: 'GET',
                headers: {
