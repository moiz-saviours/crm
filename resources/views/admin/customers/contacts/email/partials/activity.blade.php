                                ...
                                <div class="new-profile-email-wrapper">
                                    ...
                                    <div class="user_profile_text">
                                        ...
                                        <p style="font-weight: 500; padding-left: 0;">
                                            to
                                            {{ collect(is_string($item['data']['to']) ? json_decode($item['data']['to'], true) ?? [$item['data']['to']] : $item['data']['to'])->map(fn($r) => is_array($r) ? $r['email'] ?? ($r['name'] ?? 'Unknown') : $r)->implode(', ') }}
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <div class="new-profile-email-thread-wrapper">
                                        <div class="activities-seprater">Reply all</div>
                                        ...
                                        <div class="activities-seprater open-email-form">Forward</div>
                                        <div class="activities-seprater open-email-form">Delete</div>
                                    </div>
                                    <div>
                                        <p>{{ $item['data']['date']->format('d/m/Y h:i A T') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
