    ...
    <script>
        $(document).ready(function () {
            ...
            function formatDetails(d) {
                ...
                html += `<h5 class="mb-3">Above Target Spiff Resource Breakdown</h5><table class="table table-sm table-bordered mb-4"><thead class="thead-light"><tr><th>Tier</th><th class="text-right">Threshold</th><th class="text-right">Amount ($)</th><th class="text-right">Multiplier</th><th class="text-right">Commission (₨)</th></tr></thead><tbody><tr><td>2x Bonus</td><td class="text-right">≥150%</td><td class="text-right">${formatCurrency(d.above_target2x / 2, '$')}</td><td class="text-right">2x</td><td class="text-right">${formatCurrency(d.above_target2x, '₨')}</td></tr><tr><td>2.5x Bonus</td><td class="text-right">≥250%</td><td class="text-right">${formatCurrency(d.above_target2_5x / 2.5, '$')}</td><td class="text-right">2.5x</td><td class="text-right">${formatCurrency(d.above_target2_5x, '₨')}</td></tr><tr><td>3x Bonus</td><td class="text-right">≥250%</td><td class="text-right">${formatCurrency(d.above_target3x / 3, '$')}</td><td class="text-right">3x</td><td class="text-right">${formatCurrency(d.above_target3x, '₨')}</td></tr><tr class="font-weight-bold"><td colspan="4">Total Above Target Resource SPIFF</td><td class="text-right">${formatCurrency(d.total_bonus, '₨')}</td></tr></tbody></table>`;
