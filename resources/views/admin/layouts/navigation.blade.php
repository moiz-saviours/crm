...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 fixed-start"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{route('dashboard')}}"
            target="_blank">
            <img src="{{asset('assets/img/logo.png')}}" class="navbar-brand-img h-100" alt="main_logo" style="width: 100%; max-height: fit-content;">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu drop_menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="{{ route('admin.brand.index') }}"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                    <li><a class="dropdown-item" href="{{ route('admin.brand.create') }}"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                </ul>
            </li>
            <li class="nav-item">
